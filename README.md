...
**Jika Anda memerlukan tambahan module lagi dalam repo atau Jika Anda menemukan bug, silahkan report di group [@tontonvid](https://www.telegram.dog/tontovid)**
...
#### Deploy in your VPS
````bash
git clone https://github.com/Oming04/File-Oming
cd File-Oming
...
* `START_MESSAGE` Opsional: Pesan /start memulai awalan ke bot, Gunakan <a href='https://github.com/omingo04/File-Oming/blob/main/README.md#start_message'>format</a> parsemode HTML 
...
* `CUSTOM_CAPTION` letakkan teks teks Kustom Anda jika Anda ingin Mengatur Teks Kustom, Anda dapat menggunakan HTML dan <a href='https://github.com/oming04/File-Oming/blob/main/README.md#custom_caption'>fillings</a> untuk pemformatan (hanya untuk dokumen)
...
## Support   
Bergabunglah di [Group Telegram ](https://www.telegram.dog/tontovid) Untuk Dukungan/Bantuan Dan Join [Channel](https://www.telegram.dog/tontonvid) untu info Update bot.   
...
[FILE-OMING](https://github.com/oming04/File-Oming/) is Free Software: You can use, study share and improve it at your
